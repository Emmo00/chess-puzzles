...
export type CheckInReservationStatus = (typeof CHECKIN_RESERVATION_STATUSES)[number];
...
export const CheckInReservation =
  ...
  mongoose.model<ICheckInReservation>("CheckInReservation", CheckInReservationSchema);
