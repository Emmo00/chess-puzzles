...
export const PAYOUT_CLAIM_CONTRACT = "0x4DF823F6A36b35A3983afc41f7c3584C1DCBFDf1" as `0x${string}`;
export const PAYMENT_RECIPIENT = "0xEA22ca862C3AFDA79Ef7Fb5Ae8f13D245354f05b" as `0x${string}`;
...
// Re-export ABIs
export { GAME_ASSETS_ABI } from "./abis/gameAssets";
export { PAYOUT_CLAIMS_ABI, ERC20_METADATA_ABI, CHECK_IN_CLAIM_TYPES } from "./abis/payoutClaims";
export { PAYOUT_CLAIMS_EIP712_DOMAIN } from "./abis/payoutClaims";
