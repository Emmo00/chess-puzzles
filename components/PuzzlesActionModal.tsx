...
export function PuzzlesActionModal({
  ...
  return (
    <div className="fixed inset-0 z-50 p-4 flex items-center justify-center pointer-events-auto">
      ...
      <div className="relative bg-white border-4 border-black shadow-[8px_8px_0px_#000000] max-w-md w-full transform -rotate-1">
        ...
        <div className="p-6 bg-white space-y-4">
          <Link
            ...
            onClick={onClose}
            className="block bg-yellow-300 border-4 border-black p-4 shadow-[6px_6px_0px_#000000] transform rotate-1 hover:-translate-y-1 hover:-translate-x-1 transition-all"
          >
          ...
          <Link
            href="/solve-puzzles"
            onClick={onClose}
            className="block bg-lime-300 border-4 border-black p-4 shadow-[6px_6px_0px_#000000] transform -rotate-1 hover:-translate-y-1 hover:-translate-x-1 transition-all"
          >
            <div className="flex items-start justify-between gap-3">
              <div>
