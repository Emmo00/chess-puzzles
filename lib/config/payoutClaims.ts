...
export const PAYOUT_CLAIMS_ABI = [
  {
    ...
    inputs: [
      ...
      { name: "initialServerSigner", type: "address", internalType: "address" },
      { name: "initialCheckInAmount", type: "uint256", internalType: "uint256" },
      { name: "initialMaxDailyCheckIns", type: "uint256", internalType: "uint256" },
  ...
  {
    type: "function",
    name: "dailyCheckInCount",
    inputs: [{ name: "day", type: "uint256", internalType: "uint256" }],
  ...
  {
    type: "event",
    name: "CheckInAmountUpdated",
    inputs: [
      { name: "previousAmount", type: "uint256", indexed: false, internalType: "uint256" },
  ...
  {
    type: "event",
    name: "MaxDailyCheckInsUpdated",
    inputs: [
      { name: "previousMax", type: "uint256", indexed: false, internalType: "uint256" },
  ...
  { type: "error", name: "DigestAlreadyUsed", inputs: [] },
